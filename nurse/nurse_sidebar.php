...
<aside class="sidebar" id="sidebar">
  ...
  <div class="logo">
    ...
    <span>DialiEase: Nurse Panel</span>
  </div>
  ...
  <nav class="menu">
    ...
    <a href="../nurse/dashboard.php" class="menu-item" id="dashboardLink" data-tooltip="Dashboard">
      <i class="bx bx-home-smile"></i>
      <span>Dashboard</span>
    </a>

    <a href="../nurse/vitals.php" class="menu-item" id="manageSchedulesLink" data-tooltip="Vitals">
      <i class="bx bx-calendar"></i>
      <span>Scheduling</span>
    </a>


    <a href="../nurse/logs.php" class="menu-item" id="logsLink" data-tooltip="System Logs">
